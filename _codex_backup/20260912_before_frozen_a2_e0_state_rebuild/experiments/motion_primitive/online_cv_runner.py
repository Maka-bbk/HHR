"""Trajectory-only online subject-CV orchestrator.

Each member consumes the validation-selected offline trajectory checkpoint.
...
ONLINE_SCRIPT = Path(__file__).with_name("run_online.py")
