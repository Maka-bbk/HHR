"""Canonical USC-HAD-only motion-primitive trajectory offline trainer.

This entry point deliberately has no image-dataset dependency and no
...
def train(args: argparse.Namespace) -> Mapping[str, Any]:
    ...
    source_files = [
        ...
        PROJECT_ROOT / "experiments" / "motion_primitive" / "profiles.py",
