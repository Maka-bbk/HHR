"""Run the canonical registered USC-HAD offline subject-CV protocol.

This orchestrator is intentionally HAR-only and trajectory-only.  Every run
...
TRAIN_SCRIPT = Path(__file__).with_name("train_offline.py")
