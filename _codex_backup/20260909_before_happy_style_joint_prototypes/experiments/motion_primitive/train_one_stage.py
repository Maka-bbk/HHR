...
SCHEMA_VERSION = "one_stage_motion_trajectory_run_v4"
CHECKPOINT_SELECTION_POLICIES = ("common_unsupervised", "profile_default")
CODEBOOK_UPDATE_MODES = ("ema", "gradient")
...
def train_epoch(
    ...
    *,
    ...
    revived_ids = model.codebook.revive_unused_codes(
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="kmeans++",
        help="Train-only trial-balanced codebook initialization.",
    )
    ...
    parser.add_argument(
        ...
        default="ema",
        help=(
            "ema is the primary trial-balanced moving-centre update; gradient "
            "retains the differentiable codebook as an explicit ablation."
        ),
    )
...
def _validate_args(args: argparse.Namespace) -> None:
    ...
    for name in ("num_workers", "warmup_epochs", "early_stop_patience"):
