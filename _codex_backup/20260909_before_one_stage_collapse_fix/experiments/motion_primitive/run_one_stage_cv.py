...
from models.motion_trajectory import TRAJECTORY_INPUT_MODES  # noqa: E402


TRAIN_SCRIPT = Path(__file__).resolve().with_name("train_one_stage.py")
CV_SCHEMA_VERSION = "one_stage_motion_trajectory_cv_v2"
PROFILES = ("J0-U", "J0-T")
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    identity = {
        ...
        "trajectory_assignment_forward": "hard_one_hot_straight_through_gumbel",
        "aggregation_protocol": _aggregation_protocol(
