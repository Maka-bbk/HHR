...
class OnlineSingleRunnerTests(unittest.TestCase):
    def test_legacy_orchestrator_stays_direct_while_public_launchers_are_strict(self) -> None:
        ...
        self.assertIn("experiments.motion_primitive.strict_online_runner", canonical_single)
        self.assertIn("experiments.motion_primitive.strict_online_cv_runner", canonical_cv)
        for source in (
            canonical_single,
            canonical_cv,
        ...
        self.assertEqual(cv.ONLINE_SCRIPT.name, "online_runner.py")
