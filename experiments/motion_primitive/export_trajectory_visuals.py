"""Legacy joint VQ/GRU trajectory and figure exporter.

This reader is retained for historical artifacts and is not part of the
strict public route. It never participates in checkpoint
...
from experiments.motion_primitive.offline_trainer import (  # noqa: E402
    build_datasets,
    resolve_device,
)
